...
import { mailConfig } from '@eucossa-web2-product-service-config';
...
const ApiTemplatemailer = new Mailer();
ApiTemplatemailer.setHost(mailConfig.EMAIL_HOST)
...
export default ApiTemplatemailer;
